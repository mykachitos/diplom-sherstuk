const categories = [
  { id: 1, slug: "cakes", name: "Торты", product_count: 4 },
  { id: 2, slug: "pastries", name: "Пирожные", product_count: 4 },
  { id: 3, slug: "candies", name: "Конфеты", product_count: 4 },
  { id: 4, slug: "cookies", name: "Печенье", product_count: 4 },
];
...
export const LOCAL_PRODUCTS = [
  product({
    ...
    slug: "malinovyj-son",
    name: "Малиновый сон",
    description: "Нежный бисквит, малиновый конфитюр и воздушный сливочный крем.",
    price: 2800,
    originalPrice: 3300,
    weight: "1.2 кг",
    imageUrl:
  ...
  product({
    id: 4,
    slug: "fistashka-i-klubnika",
    name: "Фисташка и клубника",
    description: "Фисташковый бисквит, клубничное кули и легкий крем-чиз.",
    price: 3600,
    originalPrice: 4100,
    weight: "1.3 кг",
    imageUrl:
  ...
  product({
    ...
    slug: "limonnyj-tart",
    name: "Лимонный тарт",
    description: "Песочная основа, лимонный курд и легкая меренга.",
    price: 690,
    weight: "4 шт",
    imageUrl:
